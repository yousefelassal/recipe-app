            ...
            <div className="container px-6 py-12 mx-auto">
                ...
                <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
                    <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
                        <div>
                            <span className="inline-block p-3 text-purple-500 rounded-full bg-purple-100/80">
                            ...
                            <p className="mt-2 text-sm text-purple-500">hello@merakiui.com</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm text-gray-500">Our friendly team is here to help.</p>
                            <p className="mt-2 text-sm text-purple-500">Start new chat</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm text-purple-500 ">100 Smith Street Collingwood VIC 3066 AU</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm text-purple-500 ">0777 5000</p>
                        </div>
                    </div>
                    ...
                    <div className="p-4 py-6 rounded-lg bg-gray-50  md:p-8">
                        <form>
                            ...
                            <button className="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-purple-500 rounded-lg hover:bg-purple-400 focus:outline-none focus:ring focus:ring-purple-300 focus:ring-opacity-50">
                                Send message
                            </button>
                        </form>
                    </div>
